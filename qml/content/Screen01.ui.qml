...
Rectangle {
    ...
    Connections {
        ...
        function onMessageReceived(sender, msg, type) {
    ...
    FileDialog {
           id: fileDialog
           objectName: "img_dialog"
           currentFolder: "./"
           signal openImage(string selectedFile)
           Connections {
               function onAccepted() {
                   fileDialog.openImage(fileDialog.selectedFile)
               }
           }
    }
